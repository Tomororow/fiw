...
<script type="text/javascript" src="${ctx}/content/skin/js/distWaterReport.js"></script>
...
<div class="operate">
	<div class="" style="text-align: left;">
	   	<div id="timeSearchArea" style="float: left;">
		    ...
		    <input type="button" class="btn-search" value="查询" onclick="distWaterLists()">
			<input type="button" class="btn-reset"  value="重置" onclick="distWaterReset()">
			<input type="button" class="btn-export-report" value="报表导出" onclick="waterdistributionReport()">
		</div>
	</div>
</div>
<div id="distWaterContent"></div>
</div>