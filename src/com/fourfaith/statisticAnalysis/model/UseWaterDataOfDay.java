...
/**
 * @ClassName: UseWaterDataOfDay
 * @Description: 获取机井日统计用水量 (从真实用水量表提取)
 * @Author: zhaojinxin
 * @Date: 2018年12月4日 上午10:36:16
 */
public class UseWaterDataOfDay implements Serializable{
	...
	private BigDecimal useWaterOfDay;       // 用水量
